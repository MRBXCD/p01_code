...
def main():
    ...
    parser.add_argument('--vol_size', type=int, default=128,
                        help='size of reconstruction volume')
    parser.add_argument('--n_angle', type=int, default=2,
    ...
    # recons parameters
    parser.add_argument('--projection_path_train', type=str, default='/root/autodl-tmp/Projection_predict/projections_train_8-16_SSIM.npz',
                        help='the path to the projection data')
    parser.add_argument('--projection_path_val', type=str, default='/root/autodl-tmp/Projection_predict/projections_val_8-16_SSIM.npz',
                        help='the path to the projection data')
    ...
    parser.add_argument('--raw_voxel_path_train', type=str, default='/root/autodl-tmp/Reconstruction/data/voxel/Train_LIDC_128.npz',
                        help='the path to the voxel data')
    parser.add_argument('--raw_voxel_path_val', type=str, default='/root/autodl-tmp/Reconstruction/data/voxel/Val_LIDC_128.npz',
                        help='the path to the voxel data')
    parser.add_argument('--proj_result_path', type=str, default='/root/autodl-tmp/Reconstruction/result/projection',
                        help='the path to the voxel data')

    # results parameter
    # Set the two options below as True will lead to performance decrease.
    parser.add_argument('--if_image', type=bool, default=True,
