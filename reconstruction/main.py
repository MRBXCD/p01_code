...
def main():
    ...
    parser.add_argument('--n_angle', type=int, default=8,
    ...
    # recons parameters
    parser.add_argument('--projection_path_train', type=str, default='/home/mrb2/experiments/graduation_project/shared_data/projection/raw/Projection_train_data_8_angles_padded.npz',
                        help='the path to the projection data')
    parser.add_argument('--projection_path_val', type=str, default='/home/mrb2/experiments/graduation_project/shared_data/projection/raw/Projection_val_data_8_angles_padded.npz',
                        help='the path to the projection data')
