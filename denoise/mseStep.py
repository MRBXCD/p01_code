...
ANGLES = 128
TARGET = np.load('./data/Train/Train_Recons_SIRT_128_angles.npz')['arr_0']
INPUT = np.load(f'./data/Train/Train_LIDC_128_transposed.npz')['arr_0']
...
print(f'Loss between {ANGLES}-Raw is {error.item():.6f}')