...
plt.legend()
plt.savefig('/home/mrb2/experiments/graduation_project/p01_code/EXPs/EXP_2024.10.1.3/EXP_5_rmse_train.png')
plt.close()

plt.figure()
plt.plot(val_rmse_overall, label='validation set')
plt.legend()
plt.savefig('/home/mrb2/experiments/graduation_project/p01_code/EXPs/EXP_2024.10.1.3/EXP_5_rmse_val.png')

array_train = np.array(train_rmse_overall)
np.savetxt('/home/mrb2/experiments/graduation_project/p01_code/EXPs/EXP_2024.10.1.3/result/EXP_5_train.txt', array_train)

array_val = np.array(val_rmse_overall)
np.savetxt('/home/mrb2/experiments/graduation_project/p01_code/EXPs/EXP_2024.10.1.3/result/EXP_5_val.txt', array_val)