...
plt.savefig('/home/mrb2/experiments/graduation_project/p01_code/EXP_2024.10.1.3/EXP_5.1_rmse_train.png')
plt.close()

plt.figure()
plt.scatter(x, rmses_val)
plt.plot(x, rmses_val)
plt.savefig('/home/mrb2/experiments/graduation_project/p01_code/EXP_2024.10.1.3/EXP_5.1_rmse_val.png')